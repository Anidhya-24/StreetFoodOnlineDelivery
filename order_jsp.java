  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        ");
            ...
            int oid=r.nextInt(99999);
            String address=request.getParameter("address");
            float total = 0;//item price
            String user=session.getAttribute("user").toString();//cid
            //String foodcorner=session.getAttribute("foodcorner").toString();
      ...
      out.write("<br>");
                ...
                ids=ids+","+i.getId();//itam id
                name=name+","+i.getName();//item name
